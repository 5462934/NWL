...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__List_js__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Detail_js__ = __webpack_require__(9);
...
// 动态添加路由规则
router.addRoutes([
  { name: 'list', path: '/list', component: __WEBPACK_IMPORTED_MODULE_3__List_js__["a" /* default */] }, // 列表
  { name: 'detail', path: '/detail', component: __WEBPACK_IMPORTED_MODULE_4__Detail_js__["a" /* default */] }, // 详情
  { name: 'detail2', path: '/detail/:mid', component: __WEBPACK_IMPORTED_MODULE_4__Detail_js__["a" /* default */] }, // 详情
])

// 启动
new __WEBPACK_IMPORTED_MODULE_0__vue_js___default.a({
  el: '#app',
  render: c => c(__WEBPACK_IMPORTED_MODULE_2__App_js__["a" /* default */]),
  router
})
...
/* harmony default export */ __webpack_exports__["a"] = ({
  template: `
    <div>
      查询字符串方式：
      <ul>
        <li :class="index % 2 == 0 ? 'even' : 'odd'" v-for="(hero, index) in heros" :key="index">
          {{hero.name}}
      ...
      path方式:
        <ul>
          <li :class="index % 2 == 0 ? 'even' : 'odd'" v-for="(hero, index) in heros" :key="index">
            {{hero.name}}
            <router-link :to="{name: 'detail', params: {id: hero.id}}">查看详情</router-link>
          </li>
      </ul>
    </div>
  `,
